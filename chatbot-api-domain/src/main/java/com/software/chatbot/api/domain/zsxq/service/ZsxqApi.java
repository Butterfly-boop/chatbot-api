package com.software.chatbot.api.domain.zsxq.service;
...
import com.software.chatbot.api.domain.zsxq.model.req.AnswerReq;
import com.software.chatbot.api.domain.zsxq.model.req.ReqData;
import com.software.chatbot.api.domain.zsxq.model.res.AnswerRes;
...
public class ZsxqApi implements IZsxqApi{
    ...
    public boolean answer(String groupId, String cookie, String topicId, String text) throws IOException {
        ...
        HttpPost post = new HttpPost("https://api.zsxq.com/v2/topics/"+topicId+"/commentss");
